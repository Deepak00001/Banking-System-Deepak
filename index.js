...
mongoose.connect("mongodb+srv://Deepbanking:RT8dX0uEXZ1IWW7d@cluster0.rvxv6.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false })
    .then(() => {
